...
LINK: https://youtu.be/t8RRS3Gg-nk (video is for an old LAB. Currently, you only need to download this repo and run vagrant up from success_taste/cicd_ready_envt/. In case you are using Linux or Mac, rename Vagrantfile_MacOS_linux to Vagrantfile and run vagrant up.")
